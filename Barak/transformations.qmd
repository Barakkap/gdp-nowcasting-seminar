...
```{r}
path <- "../PROJ_DFM/nowcasting_data_raw.xlsx"
```
...
```{r}
td <- read_csv("../PROJ_DFM/data_for_sa/td_var.csv")
td_ts <- ts(
  td[, -1],
...
preadj <- read_excel("../PROJ_DFM/data_for_sa/hol_preadj.xlsx") %>%
...
```{r}
blocks_shifted_path <- "../PROJ_DFM/lag_adjusted/blocks_shifted.xlsx"
