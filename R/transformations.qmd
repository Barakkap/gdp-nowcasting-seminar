...
```{r}
head(blocks_raw$FX_liqudity$`Foreign exchange reserves (millions of shekels)`)
```
...
```{r}
td <- read_csv("C:/Users/eladb/OneDrive/Desktop/University/Bachelor's/2025 B/Nowcasting/Seasonality by Yotam/SA_CODE/Data/td_var.csv")
td_ts <- ts(
  td[, -1],
...
preadj <- read_excel("C:/Users/eladb/OneDrive/Desktop/University/Bachelor's/2025 B/Nowcasting/Seasonality by Yotam/SA_CODE/Data/hol_preadj.xlsx") %>%
...
output_path <- "C:/Users/eladb/OneDrive/Desktop/University/Bachelor's/2025 B/Nowcasting/Seminar/data/unified/combined_monthly_panel_Q_refined.xlsx"
